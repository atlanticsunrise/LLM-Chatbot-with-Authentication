...
const App = () => {
  const [chat, setChat] = useState([
    {
      role: { system: null },
      content: "How are you today? I'm here to listen."
    }
  ]);
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-50 p-4">
      <div className="flex h-[80vh] w-full max-w-2xl flex-col rounded-lg bg-white shadow-lg">
        ...
        <form className="flex rounded-b-lg border-t bg-white p-4 -m4" onSubmit={handleSubmit}>
          <input
            type="text"
